...
RUN curl -L https://github.com/splitbrain/dokuwiki/archive/release_candidate_2020-06-09.tar.gz --output dokuwiki.tar.gz && tar -xf dokuwiki.tar.gz --strip 1 -C /var/www/html && rm dokuwiki.tar.gz && \
